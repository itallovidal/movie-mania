...
export function MovieDetails() {
  ...
  return (
    <div className={'relative backdropLowOpacity h-full'}>
      ...
      <div className={`w-full text-white`}>
        <div
          className={'relative z-10 grid grid-cols-8 gap-4 min-h-[410px] py-8 '}
        >
          <div className={'col-start-3 col-span-2 row-start-1'}>
            <ImageCover display={'initial'} cover={movie.poster_path} />
          </div>
          <div className={'col-start-5 space-y-4 row-start-1 col-span-3'}>
            <div>
